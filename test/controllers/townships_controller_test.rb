...
class TownshipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create township" do
    assert_difference('Township.count') do
      post townships_url, params: { township: { description: @township.description, image: @township.image, title: @township.title } }
    end
  ...
  test "should update township" do
    patch township_url(@township), params: { township: { description: @township.description, image: @township.image, title: @township.title } }
