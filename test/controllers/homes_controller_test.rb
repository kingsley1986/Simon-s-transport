...
class HomesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create home" do
    assert_difference('Home.count') do
      post homes_url, params: { home: { description: @home.description, image: @home.image, name: @home.name } }
    end
  ...
  test "should update home" do
    patch home_url(@home), params: { home: { description: @home.description, image: @home.image, name: @home.name } }
